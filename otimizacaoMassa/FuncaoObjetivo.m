...
diam(11) = 10;%% Master 10x6
cpo(11) = .0429;
cto(11) = .102;
massaProp(11) = 20;
sp{11} = 'Master 10x6';

diam(12) = 10;%% APC sf 10x7
cpo(12) = .85;
cto(12) = .165;
massaProp(12) = 20;
sp{12} = 'APC sf 10x7';

diam(13) = 11;%% APC sf 11x3.8
cpo(13) = .105;
cto(13) = .036;
massaProp(13) = 21.83;
sp{13} = 'APC sf 11x3.8';

diam(14) = 11;%% APC sf 11x4.7
cpo(14) = .052;
cto(14) = .126;
massaProp(14) = 21.83;
sp{14} = 'APC sf 11x4.7';
...
%% Calculo da Hélice
Qh = (roh * (n/60).^2 * (diam(prop)*0.0254)^5 * (cpo(prop)/(2*pi)))*8.85;
...
tracao = roh * (nbase/60)^2 * (diam(prop)*0.0254)^4 * cto(prop);% tracao em N
