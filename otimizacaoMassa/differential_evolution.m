function [bestmem,bestval,nfeval,best_v] = de(fname,VTR,D,XVmin,XVmax,y,NP,itermax,F,CR,strategy,refresh)
...
err=[];
if nargin<1
    error('de 1st argument must be function name');
else 
    if exist(fname)<1
...
%----Output section----------------------------------------------------------
  ...
  fprintf(1,' ===============================================================================================================\n');
  if (refresh > 0)
       fprintf(1,'  Iteration: %d,          Best Value: %f,  Average: %f,  Worst: %f\n',iter,bestval,average,worst);
       for n=1:D
  ...
  best_v(iter,:)=[iter bestval];
  iter = iter + 1; 
end %---end while ((iter < itermax) ...
fprintf(1,' ===============================================================================================================\n');

%save fo.txt best_v -ASCII